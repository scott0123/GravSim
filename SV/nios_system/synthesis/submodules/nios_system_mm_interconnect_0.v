...
module nios_system_mm_interconnect_0 (
	...
	wire   [14:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_1_data_master_agent:rp_channel
	...
	wire   [14:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> nios2_qsys_1_instruction_master_agent:rp_channel
	...
	wire   [14:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> Avalon_Interface_0_AMM_Slave_agent:cp_channel
	...
	wire   [14:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sysid_qsys_1_control_slave_agent:cp_channel
	...
	wire   [14:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> nios2_qsys_1_jtag_debug_module_agent:cp_channel
	...
	wire   [14:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> keycode_s1_agent:cp_channel
	...
	wire   [14:0] cmd_demux_001_src11_channel;                                                        // cmd_demux_001:src11_channel -> cmd_mux_014:sink1_channel
	...
	wire   [14:0] rsp_demux_014_src1_channel;                                                         // rsp_demux_014:src1_channel -> rsp_mux_001:sink11_channel
	...
	wire   [14:0] sdram_s1_rsp_width_adapter_src_channel;                                             // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_007:sink_channel
	...
	wire   [14:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> sdram_s1_cmd_width_adapter:in_channel
